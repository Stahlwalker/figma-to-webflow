...
export function mapTypography(node: FigmaNode): Record<string, string> {
  ...
  // AUTO line height = browser default, omit
  ...
  switch (s.textAlignHorizontal) {
    case "LEFT": styles["text-align"] = "left"; break;
    case "CENTER": styles["text-align"] = "center"; break;
    case "RIGHT": styles["text-align"] = "right"; break;
    case "JUSTIFIED": styles["text-align"] = "justify"; break;
  }
  ...
  switch (s.textCase) {
    ...
    case "TITLE": styles["text-transform"] = "capitalize"; break;
  }

  // Text decoration
  switch (s.textDecoration) {
    case "UNDERLINE": styles["text-decoration"] = "underline"; break;
    case "STRIKETHROUGH": styles["text-decoration"] = "line-through"; break;
  }
